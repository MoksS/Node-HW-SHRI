...
const BuildDetails = () => (
  <>
    ...
    <div className="Header_Content">
      <h1 className="Header_Banner Header_Banner__color-black Header_Banner__lineHeight-l">philip1967/my-aw
        esome-repo-with-long-long-long-repo-name</h1>
      <div className="ButtonsField  ButtonsField__column-off">
        <button
          ...
          <span className="Text Text__size-m Text__lineHeight-xxl Text__weight-small Text__color-default Text__hide-on">Run
            build</span>
        </button>
